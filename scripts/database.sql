...
CREATE TABLE IF NOT EXISTS `product_order` (
    `order_command` INTEGER NOT NULL,
...
CREATE FORCE VIEW CURRENT_STOCK
SELECT P.ID, P.BARCODE, P.DESCRIPTION, S."SECTION", ST.CURRENT_STOCK FROM PRODUCT P INNER JOIN "SECTION" S ON (S.ID = P.SECTION) LEFT OUTER JOIN STOCK ST ON (ST.PRODUCT = P.ID);
