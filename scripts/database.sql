...
CREATE TABLE IF NOT EXISTS `product_order` (
    ...
    CONSTRAINT `product_fk`
        ...
        ON DELETE NO ACTION
        ON UPDATE NO ACTION,
    CONSTRAINT `product_order_status_fk`
        FOREIGN KEY (`product_status`)
        REFERENCES `product_order_status` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION
);
...
INSERT INTO `PRODUCT_ORDER_STATUS` VALUES (1, 'Ordenado' );
INSERT INTO `PRODUCT_ORDER_STATUS` VALUES (2, 'Servido' );
