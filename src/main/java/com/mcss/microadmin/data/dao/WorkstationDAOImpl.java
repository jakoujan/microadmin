...
public class WorkstationDAOImpl implements ExtendedWorkstationDAO {
    ...
    public Iterable<WorkstationView> findByFilter(WorkstationFilter filter) {
        ...
        CriteriaQuery<WorkstationView> criteria = builder.createQuery(WorkstationView.class);
        List<Predicate> predicates = new ArrayList<>();
        Root<WorkstationView> root = criteria.from(WorkstationView.class);
        ...
        CriteriaQuery<WorkstationView> where = criteria.where(builder.and(predicates.toArray(pa)));
        criteria.orderBy(builder.asc(root.get("description")));
        TypedQuery<WorkstationView> tq = manager.createQuery(where);
