...
public class ProductTypeDAOImpl implements ExtendedProductTypeDAO {
   ...
   private EntityManager manager;
    ...
    public List<ProductType> findByFilter(ProductTypeFilter filter) {
        ...
        CriteriaQuery<ProductType> where = criteria.where(builder.and(predicates.toArray(pa)));
        criteria.orderBy(builder.asc(root.get("name")));
        TypedQuery<ProductType> tq = manager.createQuery(where);
